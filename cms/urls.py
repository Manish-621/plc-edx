...
from cms.djangoapps.contentstore.views import custom_settings as custom_settings
...
urlpatterns = [
    ...
    url(r'^settings/saveCourseCustomDetails/?$', custom_settings.saveCourseCustomDetails,
        name='settings_handler_saveCourseCustomDetails'),
    
    url(r'^settings/getCourseCustomDetails/?$'.format(settings.COURSE_KEY_PATTERN), custom_settings.getCourseCustomDetails,
        name='settings_handler_getCourseCustomDetails'),
