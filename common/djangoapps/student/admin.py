...
from .models import UserRegistration, UserCourseAccess,AllowRegistration, CourseIdentifier
...
class UserCourseAccessList(admin.ModelAdmin):
    list_display = ('course_id','active_status')

class AllowRegistrationList(admin.ModelAdmin):
    list_display = ['allow']

class CourseIdentifierList(admin.ModelAdmin):
    list_display = ('AssessmentIdentifier', 'CourseKey')

class UserRegistrationList(admin.ModelAdmin):
    list_display = ('firstName','middleName','lastName','gender','dateOfBirth','contactNumber','emailId','identyType','identyNo','percentage10','percentage12','qualification','stream','collageName','yearOfPassing','gradPercentage','postGradPercentage','drive','informationSource','backlogs')
...
admin.site.register(UserRegistration,UserRegistrationList)
admin.site.register(UserCourseAccess,UserCourseAccessList)
admin.site.register(AllowRegistration,AllowRegistrationList)
admin.site.register(CourseIdentifier, CourseIdentifierList)
