...
class CoursewareIndex(View):
    ...
    def _create_courseware_context(self, request):
        ...
        course_overview = get_course_overview_with_access(
            request.user, 'load', self.course.id, check_if_enrolled=True
        )
        hide_course_tabs = True
        is_Assessment = False
        if course_overview.get_course_type() == CourseTypeChoice.Course.value :
            hide_course_tabs = False
        elif course_overview.get_course_type() == CourseTypeChoice.Assessment.value :
            is_Assessment = True
        ...
        courseware_context = {
            ...
            'hide_course_tabs':hide_course_tabs,
        ...
        if self.section:
            ...
            # Author : Naren
            # Added request object for course tree. Used in seq_module.html
            section_context['custom_request']=request
