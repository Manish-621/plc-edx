...
TIME_ZONE = 'Etc/UCT'  # http://en.wikipedia.org/wiki/List_of_tz_zones_by_name
...
INSTALLED_APPS = [
    ...
    'openedx.features.user_programs',
    'openedx.features.code_editor',
    'openedx.features.user_proctoring_system',
    'openedx.features.IDE_Exam',
    'openedx.features.user_management',
...
MAX_FAILED_LOGIN_ATTEMPTS_LOCKOUT_PERIOD_SECS = 5 * 60
...
OPTIONAL_APPS = [
    ...
    ('user_programs', 'openedx.features.user_programs'),
    ('code_editor', 'openedx.features.code_editor'),

    ('user_proctoring_system', 'openedx.features.user_proctoring_system'),
    ('IDE_Exam', 'openedx.features.IDE_Exam'),
    ('user_management', 'openedx.features.user_management'),
]
