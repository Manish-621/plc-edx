...
from openedx.features.user_proctoring_system import views as proctoring_views
...
from openedx.features.user_programs import views as program_views
from openedx.features.code_editor import views as code_editor_views
from openedx.features.IDE_Exam import views as IDE_views
from openedx.features.course_experience.views import course_home as course_experience_views
from openedx.features.user_management import views as user_mgmt_view
...
urlpatterns = [
    ...
    # Program app urls
    url(r'^FAQs/?$', program_views.get_faqs, name='FAQs'),
    url(r'^programs/P4765765(?P<id>.*)5675674?$', program_views.get_programs_by_id, name='ProgramsById'),
    url(r'^programs/api/students_update_enrollment?$', program_views.program_update_enrollment, name='programStudents_update_enrollment'),

 # added new field to the db
    url(r'^discoveryRegistration/?$', student_views.discoveryRegistration, name='discoveryRegistration'),
    url(r'^examResult/?$', student_views.examResult, name='examResult'),
    url(r'^reports/?$', student_views.reports, name='reports'),
    url(r'^addAssessmentIdentifier/?$', student_views.addAssessmentIdentifier, name='AID'),

    # proctoring urls
    url(r'^examviolation/1', proctoring_views.logBlur, name='examviolation'),
    url(r'^examviolation/2', proctoring_views.logFocus, name='examviolation'),
    url(r'^examviolation/3', proctoring_views.endExam, name='examviolation'),
    url(r'^examviolation/hhfhd4446516hfh5d4156q14561n151brr1bnc16f5r1qqghljknnnnekzf', proctoring_views.endExamView, name='examviolation'),
    url(r'^exams/timed', proctoring_views.timedExams, name='examviolation'),
    url(r'^results/timed/(?P<id>.*)$', proctoring_views.examResult, name='results'),
    url(r'^results/attempt/(?P<id>.*)$', proctoring_views.get_exam_details, name='get_exam_details'),

    # code editor urls
    url(r'^run_snippet', code_editor_views.run_snippet, name='run_snippet'),
    url(r'^run_testcases', code_editor_views.run_testcases, name='run_testcases'),
    url(r'^save_snippet', code_editor_views.save_snippet, name='save_snippet'),
    url(r'^get_code_by_questionID', code_editor_views.get_code_by_questionID, name='get_code_by_questionID'),

    # Code editor
    url(r'^code_editor/', include('openedx.features.code_editor.urls')),

    url(r'^get_ide_url', IDE_views.get_ide_url, name='get_ide_url'),
    url(r'^delete_container', IDE_views.delete_container, name='delete_container'),

    #gitHubRedirect
    url(r'^gitHubRedirect/(?P<ExamId>.*)', course_experience_views.gitHubRedirect, name='gitHubRedirect'),
    url(r'^gitForkRepository', course_experience_views.gitForkRepository, name='gitForkRepository'),
    url(r'^deleteRepository', course_experience_views.deleteRepository, name='deleteRepository'),


    # code evaluation urls
    url(r'^get_pending_responses', code_editor_views.get_pending_responses, name='get_pending_responces'),
    url(r'^get_student_response/(?P<id>.*)?$', code_editor_views.get_student_response, name='get_student_responce'),
    url(r'^update_coding_result', code_editor_views.update_coding_result, name='update_coding_result'),

    # user management urls
    url(r'^bulk_create_view', user_mgmt_view.get_bulk_create_screen, name='get_bulk_create_screen'),
    url(r'^bulk_create', user_mgmt_view.bulk_create, name='bulk_create'),
...
urlpatterns += [
    ...
    url(
        r'^courses/evaluation/students',
        instructor_dashboard_views.get_students_on_exams,
        name='instructor_evaluation',
    ),
    url(
        r'^courses/evaluation/code/P4765765(?P<id>.*)5675674?$',
        instructor_dashboard_views.get_evaluation_screen,
        name='instructor_code_evaluation',
    ),
    url(
        r'^courses/evaluationn/save_exam_score',
        instructor_dashboard_views.save_exam_score,
