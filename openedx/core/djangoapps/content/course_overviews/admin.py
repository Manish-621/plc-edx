...
from .models import CourseOverview, CourseOverviewImageConfig, CourseOverviewImageSet, CourseCustomDetails
...
class CourseOverviewAdmin(admin.ModelAdmin):
    ...
    fields = ['id','display_name','enrollment_start']
...
class CourseCustomDetailsSetAdmin(admin.ModelAdmin):
    list_display=['course_key','display_name','Duration','FocusArea','course_type_choice','course_instructions']
    readonly_fields = ['course_key','display_name']
    search_fields = ['course_key','display_name']
...
admin.site.register(CourseCustomDetails, CourseCustomDetailsSetAdmin)
